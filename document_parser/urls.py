...
urlpatterns = [
    ...
    path('accounts/signup/department/', company.DepartmentSignUpView.as_view(), name='department_signup'),
    # path('accounts/signup/company/', company.CompanySignUpView.as_view(), name='company_signup'),
    path('accounts/signup/polus/', polus.CompanySignUpView.as_view(), name='company_signup'),
]
